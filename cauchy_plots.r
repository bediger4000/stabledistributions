...
hist(b, breaks=75, freq=F, angle=-45, col="orange", density=20, add=T)
hist(ab, breaks=75, freq=F, angle=30, col="blue", density=20, add=T)
dev.off()

png("cauchy_combo_pdf.png", width=750, height=600)
hist(ab, breaks=75, freq=F, main="Combined Cauchy Distribution and Probability Density curve fit", xlab="bin center value", angle=30, col="blue", density=20)
